// ---------- PRODUCT DATABASE ----------
    const products = [
        { id: 1, name: "straight denim jeans", brand: "wrangler", price: 133.00, originalPrice: 145.00, discount: "26%", image: "productimages/a3.jpeg" },
        { id: 2, name: "GIG & POPO jeans", brand: "Levi's", price: 186.00, originalPrice: 190.00, discount: "35%", image: "productimages/images-1.jpeg" },
    ...
    if (checkoutForm) {
        checkoutForm.addEventListener('submit', function(e) {
            ...
            const mailtoLink = `mailto:support@CULTUREJEANS.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
